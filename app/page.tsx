...
// ── Custom SVG icons for each data source ─────────────────────────────────────
function FMCSAIcon() {
  return (
    <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
      {/* Shield */}
      <path d="M19 3L5 9v11c0 7.5 5.8 14.5 14 16.5 8.2-2 14-9 14-16.5V9L19 3z"
        fill="#1E3A6E" stroke="#3B82F6" strokeWidth="1.3"/>
      {/* Truck body */}
...
function NIRPIcon() {
  return (
    <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
      {/* Shield */}
      <path d="M19 3L4 9v11c0 8 6 15 15 17 9-2 15-9 15-17V9L19 3z"
        fill="#7F1D1D" stroke="#F87171" strokeWidth="1.3"/>
      {/* N initial large */}
...
function FINRAIcon() {
  return (
    <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
      {/* Bar chart */}
      <rect x="4"  y="24" width="6" height="11" rx="1" fill="#3B82F6" fillOpacity="0.55"/>
      <rect x="12" y="18" width="6" height="17" rx="1" fill="#3B82F6" fillOpacity="0.8"/>
      <rect x="20" y="11" width="6" height="24" rx="1" fill="#60A5FA"/>
      <rect x="28" y="15" width="6" height="20" rx="1" fill="#3B82F6" fillOpacity="0.7"/>
      {/* Trend line */}
      <path d="M7 24 L15 18 L23 11 L31 15"
        stroke="#BFDBFE" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
      {/* Dots on trend */}
      <circle cx="7"  cy="24" r="2" fill="#DBEAFE"/>
      <circle cx="15" cy="18" r="2" fill="#DBEAFE"/>
      <circle cx="23" cy="11" r="2" fill="#DBEAFE"/>
      <circle cx="31" cy="15" r="2" fill="#DBEAFE"/>
      {/* Baseline */}
      <line x1="3" y1="35" x2="35" y2="35" stroke="#3B82F6" strokeWidth="1.5" strokeLinecap="round"/>
      {/* FINRA badge */}
...
function DOTIcon() {
  return (
    <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
      ...
      <path d="M19 2L3 9v12c0 9 7 17 16 19 9-2 16-10 16-19V9L19 2z"
        fill="#78350F" stroke="#F59E0B" strokeWidth="1.3"/>
      {/* Highway road */}
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-ghost text-xs font-mono">
            All data sourced directly from official US federal registries — public domain, updated daily
          </p>
        </div>
